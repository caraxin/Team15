...
CLASS_SOURCES=server.cpp connection.cpp RequestMgr.cpp EchoHandler.cpp StaticHandler.cpp nginx-configparser/config_parser.cc mime_types.cpp NotFoundHandler.cpp StatusHandler.cpp ServerStatus.cpp
